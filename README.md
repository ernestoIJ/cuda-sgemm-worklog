...
All kernels are benchmarked on an NVIDIA T4 (Turing) via Lightning.AI, profiled with Nsight Compute. I'm learning CUDA and GPU architecture as I go — if you spot something I got wrong, or have resources you think would help, I'd genuinely appreciate a message on X ([@_JoyBoy_jr](https://x.com/_JoyBoy_jr)).
